...
describe('Commands Routes', () => {
  ...
  describe('GET /commands', () => {
    it('should return all commands for a guild', async () => {
      const mockCommands = [
        { _id: 'cmd1', guild_id: 'guild123', terms: '!help', response: 'Help message', role_id: '' },
        { _id: 'cmd2', guild_id: 'guild123', terms: '!info', response: 'Info message', role_id: 'role_id' },
      ];
  ...
  describe('GET /commands/id', () => {
    it('should return a command by id', async () => {
      ...
      (Command.findById as jest.Mock) = jest.fn().mockResolvedValue(mockCommand);
